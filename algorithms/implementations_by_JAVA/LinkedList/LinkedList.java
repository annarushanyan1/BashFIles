package ITC.algorithms.implementations_by_JAVA.LinkedList;
...
public class LinkedList {
    ...
    public void findNodeAt(int location) {
        ...
        if(head !=null && location<= size){
            ...
            System.out.println("LInkedList.Node item at location "+location+" is "+node.item);
        }
    }
    ...
    public void findLastNode() {
        ...
        if(head != null){
            ...
            System.out.println("LInkedList.Node item at last location is "+node.item);
        }
    }
    ...
    public void printNodes() {
        if (this.size < 1)
            ...
            for (int i = 0; i < this.size; i++) {
                System.out.println("LInkedList.Node " + current.item + " is at location " + i);
                current = current.next;
            }
        }
    }
